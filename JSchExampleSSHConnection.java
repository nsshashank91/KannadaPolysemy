...
public class JSchExampleSSHConnection {
	...
	public static void main(String[] args) {
		try {
			...
			JSchExampleSSHConnection schObj = new JSchExampleSSHConnection();
	...
	public void sshCon(java.util.Properties config) throws JSchException,
		...
		try {
			...
			copyLocalToRemote(session,
					"C:\\Users\\shashank\\workspaceKannada\\KannadaPos\\",
					"sen31", "sen31");
			session = this.getSession(config);
			executeCommand(session);
			session = this.getSession(config);
			copyRemoteToLocal(session,"./","C:\\Users\\shashank\\workspaceKannada\\KannadaPos\\", "out3");
